      ...
      <div className="p-5 border-b border-gray-50">
        ...
        {!hasData ? (
          <div className="h-80 flex flex-col items-center justify-center text-gray-400">
            ...
            <p className="text-base font-medium text-gray-400 mb-1">暂无地域分布数据</p>
            <p className="text-sm text-gray-300">当前日期范围内没有包含地理位置的记录</p>
            <p className="text-xs text-gray-300 mt-2">当用户记录包含经纬度信息后，地域分布将在此展示</p>
          </div>
        ) : (
          <>
